...
import 'package:flutter_application_1/screen/Transaksipengeluaranbarang.dart';
...
import 'package:flutter_application_1/screen/Transaksipengeluaranvoucher.dart';
class Jenistransaksipengeluaran extends StatelessWidget {
  const Jenistransaksipengeluaran({super.key});
          ...
          Padding(
            ...
            child: GestureDetector(
              onTap: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => const Transaksipengeluaranvoucher()),
                );
              },
              child: Container(
                height: 120,
          ...
          Padding(
            ...
            child: GestureDetector(
              onTap: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) =>  Transaksipengeluaranbarang()),
                );
              },
              child: Container(
                height: 120,
