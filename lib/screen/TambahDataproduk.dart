...
class TambahDataproduk extends StatefulWidget {
  ...
  @override
  State<TambahDataproduk> createState() => _TambahDataprodukState();
}

class _TambahDataprodukState extends State<TambahDataproduk> {
  ...
  final List<String> _jenisBarangList = ['Voucher', 'Kartu Provider', 'Produk'];
  ...
  void initState() {
    ...
    if (widget.postproduk != null) {
      ...
      // Set nilai dropdown jika data lama ada di list
      if (_jenisBarangList.contains(widget.postproduk!.jenis_barang)) {
        _selectedJenisBarang = widget.postproduk!.jenis_barang;
      }
    }
  }
          ...
          child: Column(
            ...
            children: [
              ...
              DropdownButtonFormField<String>(
                ...
                items: _jenisBarangList.map((String value) {
                ...
                validator: (value) => value == null ? 'Jenis barang wajib dipilih' : null,
              ),
