...
class Apidatapiutang {
  final String baseUrl = 'http://172.20.10.2:8000/api/piutang';
  final String pelangganUrl = 'http://172.20.10.2:8000/api/get-pelanggan';
  final String produkUrl = 'http://172.20.10.2:8000/api/get-produk';
